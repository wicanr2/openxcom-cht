...
build_variant() {
  ...
  local MOD_ID=$2
  local DATA_DIR=$3
  echo "==> v2.22-$VARIANT (mod=$MOD_ID)"
  local AD=/tmp/appimg/OpenXcom-CHT-v2.22-$VARIANT.AppDir
  rm -rf $AD
...
PY_EOF
  ...
  local OUT_NAME="OpenXcom-CHT-v2.22-$VARIANT-x86_64.AppImage"
