...
MonthlyReportState::MonthlyReportState(bool psi, Globe *globe) : _psi(psi), _gameOver(false), _ratingTotal(0), _fundingDiff(0), _lastMonthsRating(0), _happyList(0), _sadList(0), _pactList(0)
{
	...
	// CHT v2.22 T2: rows h 9->13, row pitch 8->13. y: 24,32,40 -> 24,37,50.
	// _txtDesc shifted y 48->63, h 132->117 (preserves bottom edge 180).
	_txtMonth = new Text(130, 13, 16, 24);
	_txtRating = new Text(160, 13, 146, 24);
	_txtIncome = new Text(300, 13, 16, 37);
	_txtMaintenance = new Text(130, 13, 16, 50);
	_txtBalance = new Text(160, 13, 146, 50);
	_txtDesc = new Text(280, 117, 16, 63);
