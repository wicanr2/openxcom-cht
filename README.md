...
| **Source patches** | 4 個 .cpp 檔（Font line step / Options baseRes / Geoscape widget / Ufopedia color） |
...
| `ArticleStateCraft.cpp + CraftWeapon.cpp` | UFOpedia 飛機介紹文字色 `Palette::blockOffset(14)+15`（淡奶油，與天空背景對比災難） → `+(15)+15`（深黑） |
