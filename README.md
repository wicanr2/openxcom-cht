...
還記得嗎？1990 年代的某個深夜，房間裡只剩 CRT 螢幕的微藍光，14 吋螢幕跳出滿屏的「`UFOPAEDIA`」「`ALIEN SUB PEN`」「`MAGNETIC NAVIGATION`」⋯⋯ 你一邊翻著第三波那本薄薄的繁中手冊，一邊指揮一群叫不出名字的水兵潛入海底。那時候沒有 wiki、沒有 Discord，只有書局架上那本印刷油墨還沒乾的手冊，跟 BBS 留言板上前輩留下的零碎攻略。

三十年過去了。

當年那群年輕人，早就變成了不同身分 — 變成了爸爸媽媽、變成了「下班還有力氣再開一場戰役」的中年玩家。多數時候只能在通勤的公車上、在小孩睡著的深夜十一點，偶爾回想起那些神作的片段。沒有時間，就沒有重玩；沒有重玩，記憶就只能停在那個 14 吋 CRT 前面。

**這次有機會了。**

我翻出了塵封三十年的 1994 / 1995 第三波官方手冊，把當年阮建成、維京工作室翻譯的「**電漿**」「**水族人**」「**潛艇修理塢**」「**黃貂魚式飛彈**」這些譯名重新校對、復原、修補誤譯。連 **34 國士兵**的英文名都用 1990 年代聯合報國際版的音譯規範，一個個拼成中文 —「`Wang Wei`」變回「**王偉**」、「`Fernando Guedes`」變成「**費南多·古艾迪斯**」。OpenXcom 那些老問題 — 字型太小、Geoscape 時鐘「星期五」被切、UFOpaedia 文字色跟天空融成一片 — 也都修好了（17 個 source patch、12 px WQY 點陣字、PaletteShift 公式調整都記錄在 [`docs/`](docs/) 裡）。
